...
int main() {
    ...
    do {
        ...
        cout << " 3 - Поиск суммы положительных чисел, оканчивающихся на 7" << endl;
...
// поиск суммы положительных чисел, оканчивающихся на 7
void getSum(list* p) {
    ...
    if (counter_pos == 0) {
        cout << "В списке нет положительных чисел, оканчивающихся на 7." << endl;
    }
    else {
